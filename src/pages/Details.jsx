            ...
            <div className='max-w-7xl mx-auto mt-16 '>
              {
                ...
                <div className="card-body">
                  ...
                  <p className='text-lg font-medium'>{service.detailed_description}</p>
                  <div className='flex gap-10 justify-evenly'>
                    <h2 className='text-xl font-semibold'> <span className='text-orange-400'>Our Classes: </span> {service.weekly_class}</h2>
